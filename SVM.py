...
print(f"⏱ Training Time (SVM): {train_time:.2f} sec")
print(f"⏱ Testing Time (SVM): {test_time:.2f} sec")
...
svm_prediction = svm.predict(img_features)
svm_pred_proba = svm.predict_proba(img_features)
pred_time = time.time() - start_pred_time

class_labels = list(train_data.class_indices.keys())
for i, prob in enumerate(svm_pred_proba[0]):
